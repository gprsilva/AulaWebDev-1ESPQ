...
// const pi = Math.PI;
// console.log("Pi com 2 casas decimais:", pi.toFixed(2));  // .toFixed() tem maior poder de manipulação


// Função para gerar número aleatório entre min e max
// function numeroAleatorioEntre(min, max) {
//   return Math.floor(Math.random() * (max - min + 1)) + min; // .random() utilizado para fazer um sorteio
// }
